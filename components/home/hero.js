export default function Hero() {
  return (
      <div className="relative isolate overflow-hidden bg-bg-light dark:bg-bg-dark py-60 bg-fixed bg-cover bg-center" style={{ backgroundImage: "url('/RealEstateBG.png')" }}>
