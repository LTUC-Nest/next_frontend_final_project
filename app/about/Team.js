...
export default function Team() {
    return (
        <div >
            <section className="justify-center animate__animated animate__bounceInUp">
                <div className="justify-center justify-center py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-6">
                    <div className="justify-center mx-auto mb-8 max-w-screen-sm lg:mb-16">
                        <h2 className="animate__animated animate__bounceInUp text-text-light dark:bg-bg-dark mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">Our team</h2>
                    </div>
                    <div className="justify-center animate__animated animate__bounceInUp text-text-light dark:bg-bg-dark grid gap-8 lg:gap-16 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
                        <div className="text-center text-gray-500 dark:text-gray-400">
                            <img className="mx-auto mb-4 w-36 h-36 rounded-full" src="/images/anas.png" alt="Anas Kanbar" />
                            <h3 className="mb-1 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
                                <a href="#">Anas Kanbar</a>
                            </h3>
                        ...
                        <div className="text-center text-gray-500 dark:text-gray-400">
                            <img className="mx-auto mb-4 w-36 h-36 rounded-full" src="/images/abdullah.png" alt="Abdullah Omar" />
                            <h3 className="mb-1 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
                                <a href="#">Abdullah Omar</a>
                            </h3>
                            <p>Full-Stack Developer</p>
                            <ul className="flex justify-center mt-4 space-x-4">
                                <li>
                        ...
                        <div className="text-center text-gray-500 dark:text-gray-400">
                            <img className="mx-auto mb-4 w-36 h-36 rounded-full" src="/images/balqes.png" alt="Jese Avatar" />
                            <h3 className="mb-1 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
                                <a href="#">Balqees Hmoud</a>
                            </h3>
                            <p>Full-Stack Developer</p>
                            <ul className="flex justify-center mt-4 space-x-4">
                                <li>
                        ...
                        <br />
                        <div className="text-center text-gray-500 dark:text-gray-400">
                            <img className="mx-auto mb-4 w-36 h-36 rounded-full" src="/images/makarm.png" alt="Makarem Abu Sosain" />
                            <h3 className="mb-1 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
                                <a href="#">Makarem Abu Sosain</a>
                            </h3>
                            <p>Full-Stack Developer</p>
                            <ul className="flex justify-center mt-4 space-x-4">
                                <li>
                        ...
                        <div className="text-center text-gray-500 dark:text-gray-400">
                            <img className="mx-auto mb-4 w-36 h-36 rounded-full" src="/images/rghad.png" alt="Raghad Alkatout" />
                            <h3 className="mb-1 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
                                <a href="#">Raghad Alkatout</a>
                            </h3>
                            <p>Full-Stack Developer</p>
                            <ul className="flex justify-center mt-4 space-x-4">
                                <li>
