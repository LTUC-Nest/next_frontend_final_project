...
const PropertyActions = React.memo(({ property, onEdit, onDelete }) => (
    <div className="flex space-x-3 mt-4">
        ...
        <button
            ...
            className="px-4 py-2 bg-red-600 text-bg-light rounded-lg hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-red-500 transition duration-150 ease-in-out"
        >
            Delete
        </button>
    </div>
            ...
            {viewMode === 'grid' ? (
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {properties.map((property) => (
                        <div key={property.id} className="bg-bg-light dark:bg-bg-dark p-4 rounded-lg shadow-sm border border-gray-200 dark:border-gray-600">
                            ...
                            <button
                                ...
                                className="mt-3 px-4 py-2 bg-primary text-bg-light rounded-lg hover:bg-primary-dark focus:outline-none focus:ring-2 focus:ring-primary-dark transition duration-150 ease-in-out"
                            >
                ...
                <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-600">
                    <thead className="bg-gray-100 dark:bg-bg-dark">
                        <tr>
                    ...
                    <tbody className="bg-white dark:bg-bg-dark divide-y divide-gray-200 dark:divide-gray-600">
                        {properties.map((property) => (
