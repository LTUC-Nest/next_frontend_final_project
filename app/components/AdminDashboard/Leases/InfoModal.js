      ...
      <div className="animate__animated animate__bounceInUp fixed inset-0 flex items-center justify-center z-50">
        ...
        <div className="bg-bg-light dark:bg-bg-dark p-6 rounded shadow-md relative z-10 w-full max-w-3xl border border-primary-dark dark:border-primary">
          ...
          <div className="flex items-center mb-2">
            ...
            <p>
              <strong className="text-text-dark dark:text-text-light">Tenant:</strong> {lease.tenant_name}
            </p>
          </div>
          ...
          <div className="flex items-center mb-2">
            ...
            <p>
              <strong className="text-text-dark dark:text-text-light">Property:</strong> {lease.property_name}
            </p>
          </div>
          ...
          <div className="flex items-center mb-2">
            ...
            <p>
              <strong className="text-text-dark dark:text-text-light">Rent Amount:</strong> ${lease.rent_amount}
            </p>
          </div>
          ...
          <div className="flex items-center mb-2">
            ...
            <p>
              <strong className="text-text-dark dark:text-text-light">Lease Start Date:</strong> {lease.lease_start_date}
            </p>
          </div>
          ...
          <div className="flex items-center mb-2">
            <CalendarIcon className="h-5 w-5 text-text-dark dark:text-text-light mr-2" />
            <p>
              <strong className="text-text-dark dark:text-text-light">Lease End Date:</strong> {lease.lease_end_date}
            </p>
          </div>
          ...
          <div className="flex items-center mb-2">
            <CurrencyDollarIcon className="h-5 w-5 text-text-dark dark:text-text-light mr-2" />
            <p>
              <strong className="text-text-dark dark:text-text-light">Security Deposit:</strong> ${lease.security_deposit}
            </p>
          </div>
          {/* Last Paid Date */}
          <div className="flex items-center mb-2">
          <CalendarIcon className="h-5 w-5 text-text-dark dark:text-text-light mr-2" />
          <p>
            <strong className="text-text-dark dark:text-text-light">Last Paid Date:</strong> {lease.last_paid_date}
          </p>
        </div>
          {/* Payment Frequency */}
          <div className="flex items-center mb-2">
            ...
            <p>
              <strong className="text-text-dark dark:text-text-light">Payment Frequency:</strong> {lease.payment_frequency}
            </p>
          </div>
          ...
          <div className="flex items-center mb-2">
            ...
            <p>
              <strong className="text-text-dark dark:text-text-light">Lease Terms:</strong> {lease.lease_terms}
            </p>
          </div>
          ...
          <div className="flex items-center mb-2">
            <ClockIcon className="h-5 w-5 text-text-dark dark:text-text-light mr-2" />
            <p>
              <strong className="text-text-dark dark:text-text-light">Created At:</strong> {lease.created_at}
            </p>
          </div>
          ...
          <div className="flex items-center mb-2">
            <p>
              <strong className="text-text-dark dark:text-text-light">Status:</strong> {lease.is_active ? (
                <>
