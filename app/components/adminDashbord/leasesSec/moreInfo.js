  ...
  return (
    <div className="fixed z-10 inset-0 overflow-y-auto bg-gray-500 bg-opacity-50 flex items-center justify-center">
      <div className="bg-white p-6 rounded-lg shadow-lg w-96">
        <h2 className="text-xl font-bold text-center mb-4">Lease Information</h2>

        {/* Tenant */}
        <div className="flex items-center mb-2">
          <UserIcon className="h-5 w-5 text-gray-700 mr-2" />
          <p className="text-gray-700"><strong>Tenant:</strong> {lease.tenant_name}</p>
        </div>

        {/* Property */}
        <div className="flex items-center mb-2">
          <HomeIcon className="h-5 w-5 text-gray-700 mr-2" />
          <p className="text-gray-700"><strong>Property:</strong> {lease.property_name}</p>
        </div>

        {/* Rent Amount */}
        <div className="flex items-center mb-2">
          <CurrencyDollarIcon className="h-5 w-5 text-gray-700 mr-2" />
          <p className="text-gray-700"><strong>Rent Amount:</strong> ${lease.rent_amount}</p>
        </div>

        {/* Lease Start Date */}
        <div className="flex items-center mb-2">
          <CalendarIcon className="h-5 w-5 text-gray-700 mr-2" />
          <p className="text-gray-700"><strong>Lease Start Date:</strong> {lease.lease_start_date}</p>
        </div>

        {/* Lease End Date */}
        <div className="flex items-center mb-2">
          <CalendarIcon className="h-5 w-5 text-gray-700 mr-2" />
          <p className="text-gray-700"><strong>Lease End Date:</strong> {lease.lease_end_date}</p>
        </div>

        {/* Security Deposit */}
        <div className="flex items-center mb-2">
          <CurrencyDollarIcon className="h-5 w-5 text-gray-700 mr-2" />
          <p className="text-gray-700"><strong>Security Deposit:</strong> ${lease.security_deposit}</p>
        </div>

        {/* Payment Frequency */}
        <div className="flex items-center mb-2">
          <ClockIcon className="h-5 w-5 text-gray-700 mr-2" />
          <p className="text-gray-700"><strong>Payment Frequency:</strong> {lease.payment_frequency}</p>
        </div>

        {/* Lease Terms */}
        <div className="flex items-center mb-2">
          <DocumentTextIcon className="h-5 w-5 text-gray-700 mr-2" />
          <p className="text-gray-700"><strong>Lease Terms:</strong> {lease.lease_terms}</p>
        </div>

        {/* Created At */}
        <div className="flex items-center mb-2">
          <ClockIcon className="h-5 w-5 text-gray-700 mr-2" />
          <p className="text-gray-700"><strong>Created At:</strong> {lease.created_at}</p>
        </div>
